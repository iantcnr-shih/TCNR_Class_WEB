...
const AdminTechForum = () => {
  ...
  const currentContent = getContentForMenu("tech-forum");
  ...
  const activeMenuItem = menuItems.find(item => item.id === "tech-forum");
