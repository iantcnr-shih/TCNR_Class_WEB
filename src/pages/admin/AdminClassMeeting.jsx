...
const AdminClassMeeting = () => {
  ...
  const currentContent = getContentForMenu("class-meeting");
  ...
  const activeMenuItem = menuItems.find(item => item.id === "class-meeting");
...
export default AdminClassMeeting;